...
@Getter
@Builder
public class SolutionItemHistoryResponse {
    ...
    public static SolutionItemHistoryResponse from(QuotationSolutionItemHistory item) {
        return SolutionItemHistoryResponse.builder()
                .id(item.getId())
                .productModuleId(
