...
public class PrbProjectInfo {
    ...
    public PrbProjectInfo copy() {
        return PrbProjectInfo.builder()
                .projectStartDate(this.projectStartDate)
                .projectEndDate(this.projectEndDate)
                .bidType(this.bidType)
                .preSpecNoticeDate(this.preSpecNoticeDate)
                .officialNoticeDate(this.officialNoticeDate)
                .priceBiddingDatetime(this.priceBiddingDatetime)
                .proposalDeadlineDatetime(this.proposalDeadlineDatetime)
                .proposalPresentationDatetime(this.proposalPresentationDatetime)
                .technicalEvalRatio(this.technicalEvalRatio)
                .priceEvalRatio(this.priceEvalRatio)
                .build();
    }
}
