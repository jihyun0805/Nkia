# 인수인계: 결재/업무 프로세스 상태를 질문에서 추출하고 조회 계획으로 바꾸는 로직입니다.
# 핵심 흐름: 견적/계약/프로젝트의 approval/workflow 관련 질문을 정형 경로로 보냅니다.
# 같이 확인: 백엔드 workflow 테이블 필드 변경 시 structured_answer_service 조회도 확인하세요.
