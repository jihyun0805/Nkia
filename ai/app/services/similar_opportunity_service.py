# 인수인계: 특정 사업기회와 비슷한 과거 수주 사례를 찾아 추천/초안 답변에 붙이는 서비스입니다.
# 핵심 흐름: 사업 설명과 메타데이터를 기준으로 유사도를 계산해 “비슷한 사례” 근거를 보강합니다.
# 같이 확인: 임베딩 모델이나 opportunity metadata 변경 시 search/indexing 쪽 재색인을 같이 고려하세요.
