// 인수인계: 대화 메시지 리스트를 렌더링하는 컴포넌트입니다.
// 핵심 흐름: assistant 메시지는 타이핑 중이면 typedAssistantContent를 대신 보여주고, 근거/액션 영역을 함께 붙입니다.
// 같이 확인: 메시지 필드 추가 시 types.ts와 ChatbotModal의 message mapping을 같이 수정하세요.
"use client"
