// 인수인계: 프론트 챗봇 표시/변환 유틸입니다.
// 핵심 흐름: 세션 제목 요약, 날짜/파일 크기 포맷, evidence section 구성, 서버 메시지 payload 파싱을 담당합니다.
// 같이 확인: 메시지 저장 필드가 늘어나면 parseJson/mapChatMessagePayload를 같이 업데이트하세요.
import type {
  ChatbotDraftAction,
  ChatbotEvidence,
