              ...
              {license.fields.map((f, i) => (
                <tr key={f.id} className="border-b border-black relative group">
                  <td className="border-r border-black p-0" colSpan={1}>
                    <input className={cellInput} {...register(`licenseDetails.${i}.category`)} />
                  </td>
                  <td className="border-r border-black p-0" colSpan={1}>
                    <input className={cellInput} {...register(`licenseDetails.${i}.group`)} />
                  </td>
                  <td className="border-r border-black p-0" colSpan={3}>
                    <input className={cellInput} {...register(`licenseDetails.${i}.product`)} />
                  </td>
                  <td className="border-r border-black p-0" colSpan={1}>
                  ...
                  <td className="p-0" colSpan={2}>
                    <input className={`${cellInput} text-right`} {...registerNumber(`licenseDetails.${i}.subtotal`)} />
                  </td>
