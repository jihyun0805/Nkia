...
export default function FindingPage() {
  ...
  const [activeTab, setActiveTab] = useState<"opportunities" | "customers" | "partners">(
  ...
  const handleTabChange = (value: "opportunities" | "customers" | "partners") => {
    setActiveTab(value)
  ...
  const findingFieldOptions = activeTab === "opportunities"
    ...
    : activeTab === "customers"
      ? [{ key: "category", label: "고객군", options: uniqueOptions(customerRows, (i) => i.category) }]
  ...
  const filteredCustomers = filterRecords(customerRows, filters, { owner: (i) => i.contact, fields: { category: (i) => i.category } }).filter((i) => [i.id, i.name, i.contact, i.phone].join(" ").toLowerCase().includes(q))
  ...
  const registerHref =
    activeTab === "customers" ? "/finding/new/customers" : activeTab === "partners" ? "/finding/new/partners" : "/finding/new/opportunities"
  const registerLabel =
