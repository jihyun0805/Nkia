...
import { findingStatuses, getCustomerByName, getFindingCategoryLabel, getPartnerByName, registerCustomer, registerOpportunity, registerPartner, type CustomerContact, type CustomerRecord } from "@/lib/finding-data"
