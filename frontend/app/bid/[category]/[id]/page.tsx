...
export default async function BidDetailPage({ params }: { params: Promise<{ category: BidCategory; id: string }> }) {
  ...
  const approvalSteps = category === "result" ? ["제안 담당자", "팀장", "본부장", "공유 권한 보유자"] : ["영업대표", "팀장", "본부장", "배포 권한 보유자", "공유 권한 보유자"]
